...
ad_interface signal dma_data input DMA_DATA_WIDTH data
...
proc p_avl_dacfifo_elab {} {
  ...
  add_hdl_instance ad_mem_asym_wr ad_mem_asym
  ...
  add_hdl_instance ad_mem_asym_rd ad_mem_asym
  ...
  add_hdl_instance ad_mem_asym_bypass ad_mem_asym
